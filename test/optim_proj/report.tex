...
$$
where we use the standard least square model that directly measures how well the model reconstructs the input. %The topography of Auto-encoder could be seen in Figure 1.
