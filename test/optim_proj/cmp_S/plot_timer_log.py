...
def main():
    ...
    id = range(1, 7)
    for id_elem in id:
        plot_loss(id_elem, 40, 20)
        plot_loss(id_elem, 80, 20)
        plot_loss(id_elem, 120, 20)
        plot_loss(id_elem, 160, 20)
        plot_loss(id_elem, 40, 10)
        plot_loss(id_elem, 80, 10)
        plot_loss(id_elem, 110, 10)
        plot_loss(id_elem, 160, 10)
